...
export default createStore({
  ...
  mutations: {
    ...
    UPDATE_USER_SAVED(state){
      ...
      axios.post(`https://bakteria.online:5000/api/users/update-user/saved`, {
        id: state.user.id,
    ...
    UPDATE_USER_HIDDEN(state){
      axios.post(`https://bakteria.online:5000/api/users/update-user/hidden`, {
        id: state.user.id,
    ...
    UPDATE_USER_LIKED(state){
      axios.post(`https://bakteria.online:5000/api/users/update-user/liked`, {
        id: state.user.id,
    ...
    LIKE_MANGA(state, id){
      ...
      axios.get(`https://bakteria.online:5000/api/mangas/like/${id}`)
      .then(res => console.log(res.data))
      .catch(res => console.log(res.data) )
    },
    DISLIKE_MANGA(state,id){
      console.log(state.user.id)
      axios.get(`https://bakteria.online:5000/api/mangas/like/${id}?like=-1`)
      .then(res => console.log(res.data))
      .catch(res => console.log(res.data) )
    },
