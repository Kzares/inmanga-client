...
const uploadImage = (id) => {
    ...
    axios.post(`http://149.100.154.239:5000/image/${filename}`, formData, {
        headers: {
...
const submitData = async () => {
    loader.value = true
    if (props.isEdit) {
        axios.put(`http://149.100.154.239:5000/api/mangas/edit/${route.params.id}`, {
            title: state.title,
            author: state.author,
            released: state.date,
        ...
        axios.post(`http://149.100.154.239:5000/api/mangas/add`, {
            title: state.title,
            author: state.author,
            released: state.date,
            sinopsis: state.sinopsis,
        ...
        <main>
            ...
            <div class="image">
                ...
                <label for="fileInput" v-else>
                    <img v-if="isEdit" :src="`http://149.100.154.239:5000/download/${state.id}.jpg`" alt="">
                </label>
